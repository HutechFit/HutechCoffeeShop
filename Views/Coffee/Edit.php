...
<!--                                    <input type="hidden" name="Id" value="--><?php //echo $coffee->Id; ?><!--">-->
                                    <div class="col-md-12 ">
                                        <input class="contactus form-control" placeholder="Tên sản phẩm" type="text" name="Name">
                                    </div>
                                    <div class="col-md-12">
                                        <input class="contactus form-control" placeholder="Giá tiền" type="number" name="Price">
                                    </div>
                                    <div class="col-md-12">
                                        <input class="contactus form-control" placeholder="Hình ảnh" type="file" name="Image">
                                    </div>
                                    <div class="col-md-12">
                                        <textarea class="textarea form-control" placeholder="Mô tả sản phẩm" type="type" name="Description"></textarea>
                                    </div>
                                    <div class="col-md-12">
