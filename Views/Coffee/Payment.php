...
<?php if (empty($vnp_SecureHash)) : ?>
    <div class="d-flex
        ...
        <div class="text-center">
            <h1 class="display-1
                       fw-bold
                       text-info">Không tồn tại</h1><br>
            <p class="fs-3">
                <span class="text-danger">Opps!</span> Hoá đơn không tồn tại.
            </p>
            <p class="lead">
                Hãy thử lại.
            </p>
                            ...
                            <div class="col-md-4 gradient-custom text-center text-white"
                                ...
                                <?php if ($secureHash !== $vnp_SecureHash) : ?>
                                    ...
                                    <h6 class="text-danger
                                               text-center">Chữ ký không hợp lệ</h6>
                                    <a href="/" class="btn
                                                       btn-outline-danger
                                                       mt-4">Trang chủ</a>
                                <?php else : ?>
                                    <?php if ($vnp_ResponseCode !== '00') : ?>
                                        <img src="https://www.svgrepo.com/show/444337/gui-check-no.svg"
                                             ...
                                             style="width: 80px;"/>
                                        <h6 class="text-danger
                                                   text-center">Thanh toán thất bại</h6>
                                        <a href="/" class="btn
                                                           btn-outline-danger
                                                           mt-4">Trang chủ</a>
                                    <?php else : ?>
                                        ...
                                        <h6 class="text-success
                                                   text-center">Thanh toán thành công</h6>
                                        <a href="/" class="btn
                                                           btn-outline-success
                                                           mt-4">Trang chủ</a>
                                    <?php endif; ?>
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <div class="row pt-1">
                                        <div class="col-6 mb-3">
                                            ...
                                            <p class="text-muted">
                                                <?= date('d/m/Y', strtotime($_GET['vnp_PayDate'])) ?>
                                            </p>
                                        </div>
                                        <div class="col-6 mb-3">
